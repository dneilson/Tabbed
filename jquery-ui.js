...
function performSearch() {
    ...
    window.open('http://hbportal.corp.intranet/portal/server.pt?in_tx_query=' + searchTerm + '&in_hi_space=SearchResult&in_hi_control=searchstart&cached=false&in_hi_opt_allfold_ddfolder=1798&in_hi_opt_allfold_apps=1&in_hi_opt_thisfold_ddfolder=1798&in_hi_opt_thisfold_apps=1&in_hi_space=SearchResult&in_hi_req_objtype=18&in_se_sel_1=thisfold', 'new_window_2');
    window.open('http://einstein.qintra.com/selfservice/microsites/searchEntry.do?searchString=' + searchTerm + ('&businessunit=UMBU_BUSINESSMARKETSGROUP_2_2&document=noselection&product=noselection&searchMode=GuidedSearch&rwTarget=%2FrfPlayerWidget.do&cmd=search&productFamily=&forum=&accesslevels=SAL_INTERNAL_1_3&locale=LA_eng_US&contextType=gs&showSavedSearches=true&usemicrosite=true&evaluateRF=true'), 'new_window_3');
}
...
function performSea() {
    var searchTerm = encodeURIComponent(document.getElementById('searchField4').value);
    window.open('http://hbportal.corp.intranet/portal/server.pt?in_tx_query=' + searchTerm + '&in_hi_space=SearchResult&in_hi_control=searchstart&cached=false&in_hi_opt_allfold_ddfolder=1798&in_hi_opt_allfold_apps=1&in_hi_opt_thisfold_ddfolder=1798&in_hi_opt_thisfold_apps=1&in_hi_space=SearchResult&in_hi_req_objtype=18&in_se_sel_1=thisfold', 'new_window_2');
}
...
function pop(url) {
    newWindow = window.open(url, 'name', 'width=1000,height=800,titlebar=no,scrollbars=yes');
    newWindow.focus();
    return false;
}
function acronym(url) {
    newWindow = window.open(url, 'acronym', 'width=1000,height=800,titlebar=no,scrollbars=yes');
    newWindow.focus();
    return false;
}
function popp(url) {
    newWindow = window.open(url, 'sfa', 'width=1500,height=900,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function bmi(url) {
    newWindow = window.open(url, 'bmi', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function ein(url) {
    newWindow = window.open(url, 'ein', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function dspmatrix(url) {
    newWindow = window.open(url, 'dspmatrix', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function tmi(url) {
    newWindow = window.open(url, 'tmi', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function ebill(url) {
    newWindow = window.open(url, 'ebill', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function irep(url) {
    newWindow = window.open(url, 'irep', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function vqt(url) {
    newWindow = window.open(url, 'vqt', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function slc(url) {
    newWindow = window.open(url, 'slc', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function prodwiz(url) {
    newWindow = window.open(url, 'prodwiz', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function loopqual(url) {
    newWindow = window.open(url, 'loopqual', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function qvo(url) {
    newWindow = window.open(url, 'qvo', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
function salespricingtool(url) {
    newWindow = window.open(url, 'salespricingtool', 'width=1000,height=800,titlebar=yes,scrollbars=yes');
    newWindow.focus();
    return false;
}
